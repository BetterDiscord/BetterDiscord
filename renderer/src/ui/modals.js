...
export default class Modals {
    static get shouldShowAddonErrors() {
        return Settings.get("settings", "addons", "addonErrors");
    }
    ...
    static get ModalComponents() {
        return WebpackModules.getByProps("ModalRoot");
    }
    static get ModalClasses() {
        return WebpackModules.getByProps("modal", "content");
    }
    static get AlertModal() {
        return WebpackModules.getByPrototypes(
            "handleCancel",
            "handleSubmit",
            "handleMinorConfirm"
        );
    ...
    static get FlexElements() {
        return WebpackModules.getByProps("Child", "Align");
    }
    static get FormTitle() {
        return WebpackModules.findByDisplayName("FormTitle");
    }
    static get TextElement() {
        return WebpackModules.getByProps("Sizes", "Weights");
    }
    static get ConfirmationModal() {
        return WebpackModules.findByDisplayName("ConfirmModal");
    }
    static get Markdown() {
        return WebpackModules.findByDisplayName("Markdown");
    }
    static get Buttons() {
        return WebpackModules.getByProps("ButtonColors");
    }
    ...
    static showConfirmationModal(title, content, options = {}) {
        ...
        content = content.map((c) =>
            typeof c === "string" ? React.createElement(Markdown, null, c) : c
        );
                    ...
                    Object.assign(
                        {
                            ...
                            confirmButtonColor: danger
                                ? this.Buttons.ButtonColors.RED
                                : this.Buttons.ButtonColors.BRAND,
    ...
    static showAddonErrors({
        ...
        if (this.addonErrorsRef && this.addonErrorsRef.current) {
            return this.addonErrorsRef.current.refreshTabs(
                Array.isArray(pluginErrors) ? pluginErrors : [],
                Array.isArray(themeErrors) ? themeErrors : []
            );
        }
        ...
        this.ModalActions.openModal((props) =>
            React.createElement(
                this.ModalComponents.ModalRoot,
                Object.assign(props, {
                    size: this.ModalComponents.ModalSize.LARGE,
    ...
    static showChangelogModal(options = {}) {
        const ModalStack = WebpackModules.getByProps(
            "push",
            "update",
            "pop",
            "popWithKey"
        ...
        const Changelog = WebpackModules.getModule(
            (m) => m.defaultProps && m.defaultProps.selectable == false
        );
        const MarkdownParser = WebpackModules.getByProps("defaultRules", "parse");
        if (
            !Changelog || !ModalStack || !ChangelogClasses || !TextElement || !FlexChild || !Titles || !MarkdownParser
        ) {
            return Logger.warn("Modals", "showChangelogModal missing modules");
        }

        const {
            image = "https://i.imgur.com/8sctUVV.png",
            description = "",
            changes = [],
            title = "BetterDiscord",
        ...
        if (description) {
            changelogItems.push(ce("p", null, MarkdownParser.parse(description)));
        }
        for (let c = 0; c < changes.length; c++) {
            const entry = changes[c];
            const type = ChangelogClasses[entry.type]
                ? ChangelogClasses[entry.type]
                : ChangelogClasses.added;
        ...
        const ModalActions = this.ModalActions;
        const OriginalModalClasses = WebpackModules.getByProps(
            "hideOnFullscreen",
            "root"
        );
                ...
                Object.assign(
                    {
                        ...
                        renderFooter: renderFooter(props.onClose ?? (() => {})),
                    },
                    props
                ),
                changelogItems
    ...
    static showAddonSettingsModal(name, panel) {
        ...
        const modal = (props) => {
            return React.createElement(
                mc.ModalRoot,
                Object.assign(
                    {size: mc.ModalSize.MEDIUM, className: "bd-addon-modal"},
                    props
                ),
                React.createElement(
                    mc.ModalHeader,
                    {separator: false, className: "bd-addon-modal-header"},
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        {onClick: props.onClose, className: "bd-button"},
                        Strings.Modals.done
                    )
                )
            );
