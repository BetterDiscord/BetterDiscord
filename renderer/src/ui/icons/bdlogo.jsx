...
export default function BDLogo(props) {
    return <svg viewBox="0 0 2000 2000" fill={props.color || "#FFFFFF"} width={"size" in props ? props.size || "24px" : props.width} height={"size" in props ? props.size || "24px" : props.height} size onClick={props.onClick} className={props.className}>
        <g>
