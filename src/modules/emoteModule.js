...
EmoteModule.prototype.init = async function () {
    ...
    const emoteInfo = {
        TwitchGlobal: {
            url: `https://Lone-Soul.github.io/BetterDiscordApp/assets/emotedata_twitch_global.json`,
            variable: "TwitchGlobal",
            oldVariable: "emotesTwitch",
            getEmoteURL: (e) => `https://static-cdn.jtvnw.net/emoticons/v1/${e}/1.0`
        },
        TwitchSubscriber: {
            url: `https://Lone-Soul.github.io/BetterDiscordApp/assets/emotedata_twitch_subscriber.json`,
            variable: "TwitchSubscriber",
            oldVariable: "subEmotesTwitch",
            getEmoteURL: (e) => `https://static-cdn.jtvnw.net/emoticons/v1/${e}/1.0`
        },
        FrankerFaceZ: {
            url: `https://Lone-Soul.github.io/BetterDiscordApp/assets/emotedata_ffz.json`,
            variable: "FrankerFaceZ",
            oldVariable: "emotesFfz",
            getEmoteURL: (e) => `https://cdn.frankerfacez.com/emoticon/${e}/1`
        },
        BTTV: {
            url: `https://Lone-Soul.github.io/BetterDiscordApp/assets/emotedata_bttv.json`,
            variable: "BTTV",
            oldVariable: "emotesBTTV",
            getEmoteURL: (e) => `https://cdn.betterttv.net/emote/${e}/1x`
        },
        BTTV2: {
            url: `https://Lone-Soul.github.io/BetterDiscordApp/assets/emotedata_bttv2.json`,
            variable: "BTTV2",
