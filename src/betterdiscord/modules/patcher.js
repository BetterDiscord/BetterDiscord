...
export default class Patcher {
    ...
    static resolveModule(module) {
        if (
            !module || typeof module === "function" || (typeof module === "object" && !Array.isArray(module))
        ) {return module;}
    ...
    static pushChildPatch(
        ...
        if (!module[functionName] && forcePatch) module[functionName] = () => {};
        ...
        const patch = this.patches.find(
            (p) => p.module == module && p.functionName == functionName,
            ...
            unpatch: () => {
                patch.children.splice(
                    patch.children.findIndex(
                        (cpatch) => cpatch.id === child.id && cpatch.type === type,
                    ),
                    1,
                );
