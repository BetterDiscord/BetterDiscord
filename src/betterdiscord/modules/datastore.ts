...
export default new class DataStore {
    ...
    webpackCache?: Record<string, string>;
    ...
    getWebpackCache() {
        ...
        else this.webpackCache = JSON.parse(fs.readFileSync(this.webpackCachePath).toString());

        return this.webpackCache!;
    }

    saveWPCDebounce?: Timer;
    saveWPC?: Timer;

    setWebpackCache(cache: Record<string, string>) {
