...
export default class Notices {
    ...
    static get baseClass() {return this.__baseClass ??= getByKeys<{base: string;}>(["container", "base", "sidebar"], {cacheId: "core-notices-baseClasses"})?.base;}
    static get errorPageClass() {return this.__errorPageClass ??= getByKeys<{errorPage: string;}>(["errorPage"], {cacheId: "core-notices-errorClasses"})?.errorPage;}
