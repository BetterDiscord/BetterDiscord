...
const AccessibilityContext = getModule<Context<{reducedMotion: {enabled: false;};}>>(m => m?._currentValue?.reducedMotion, {searchExports: true, cacheId: "core-spinner-AccessibilityContext"}) || React.createContext({
