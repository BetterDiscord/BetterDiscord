...
function updateExtData() {
    var repoLeadup = '//' + _cfg.updater.CDN + '/' + _cfg.repo + '/BetterDiscordApp/' + _cfg.hash;
    if (_cfg.updater.CDN === 'rauenzi.github.io') repoLeadup = '//rauenzi.github.io/BetterDiscordApp';
    _extData = {
        'load-jQueryCookie': {
            'type': 'javascript',
        ...
        'load-mainCSS': {
            ...
            'url': repoLeadup + '/css/main.min.css',
