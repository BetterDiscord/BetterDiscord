...
const BetterDiscord = class BetterDiscord {
    ...
    get externalData() {
        return [
            ...
            {
                type: "style",
                url: "//cdn.staticaly.com/gh/rauenzi/BetterDiscordApp/master/css/main.min.css",
                backup: "//rauenzi.github.io/BetterDiscordApp/css/main.min.css",
                local: config.localServer + "/BetterDiscordApp/css/main.css"
            },
            {
                type: "script",
                url: "//cdn.staticaly.com/gh/rauenzi/BetterDiscordApp/master/js/main.min.js",
    ...
    async loadApp() {   
        for (const data of this.externalData) {
            const url = (config.local && data.local != null) ? data.local : data.url;
...
module.exports.BetterDiscord = BetterDiscord;