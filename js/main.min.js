(function(){let a=window.require("fs"),s=window.require("process"),r=s.platform,n=("win32"===r?s.env.APPDATA:"darwin"===r?s.env.HOME+"/Library/Preferences":process.env.HOME+"/.config")+"/BetterDiscord/",o="localStorage.json",l={};if(a.existsSync(`${n}${o}`))try{l=JSON.parse(a.readFileSync(`${n}${o}`))}catch(h){console.log(h)}else if(a.existsSync(o))try{l=JSON.parse(a.readFileSync(o))}catch(h){console.log(h)}var d=l;d.setItem=function(h,g){d[h]=g,this.save()},d.getItem=function(h){return d[h]||null},d.save=function(){a.writeFileSync(`${n}${o}`,JSON.stringify(this),null,4)};var u=new Proxy(d,{set:function(h,g,b){d[g]=b,d.save()},get:function(h,g){return d[g]||null}});window.localStorage=u})(),(()=>{let a=document.createElement("div");a.className="bd-loaderv2",a.title="BetterDiscord is loading...",document.body.appendChild(a)})(),window.bdStorage={},window.bdStorage.get=function(a){return betterDiscordIPC.sendSync("synchronous-message",{arg:"storage",cmd:"get","var":a})},window.bdStorage.set=function(a,s){betterDiscordIPC.sendSync("synchronous-message",{arg:"storage",cmd:"set","var":a,data:s})},window.bdPluginStorage={},window.bdPluginStorage.get=function(a,s){return betterDiscordIPC.sendSync("synchronous-message",{arg:"pluginstorage",cmd:"get",pn:a,"var":s})},window.bdPluginStorage.set=function(a,s,r){betterDiscordIPC.sendSync("synchronous-message",{arg:"pluginstorage",cmd:"set",pn:a,"var":s,data:r})},betterDiscordIPC.on("asynchronous-reply",(a,s)=>{console.log(a),console.log(s)});var settingsPanel,emoteModule,utils,quickEmoteMenu,voiceMode,pluginModule,themeModule,dMode,publicServersModule,jsVersion=1.792,supportedVersion="0.2.81",bbdVersion="0.0.1",mainObserver,twitchEmoteUrlStart="https://static-cdn.jtvnw.net/emoticons/v1/",twitchEmoteUrlEnd="/1.0",ffzEmoteUrlStart="https://cdn.frankerfacez.com/emoticon/",ffzEmoteUrlEnd="/1",bttvEmoteUrlStart="https://cdn.betterttv.net/emote/",bttvEmoteUrlEnd="/1x",mainCore,settings={"Save logs locally":{id:"bda-gs-0",info:"Saves chat logs locally",implemented:!1,hidden:!1,cat:"core"},"Public Servers":{id:"bda-gs-1",info:"Display public servers button",implemented:!1,hidden:!1,cat:"core"},"Minimal Mode":{id:"bda-gs-2",info:"Hide elements and reduce the size of elements.",implemented:!0,hidden:!1,cat:"core"},"Voice Mode":{id:"bda-gs-4",info:"Only show voice chat",implemented:!0,hidden:!1,cat:"core"},"Hide Channels":{id:"bda-gs-3",info:"Hide channels in minimal mode",implemented:!0,hidden:!1,cat:"core"},"Dark Mode":{id:"bda-gs-5",info:"Make certain elements dark by default(wip)",implemented:!0,hidden:!1,cat:"core"},"Override Default Emotes":{id:"bda-es-5",info:"Override default emotes",implemented:!1,hidden:!1,cat:"core"},"Voice Disconnect":{id:"bda-dc-0",info:"Disconnect from voice server when closing Discord",implemented:!0,hidden:!1,cat:"core"},"Custom css live update":{id:"bda-css-0",info:"",implemented:!0,hidden:!0,cat:"core"},"Custom css auto udpate":{id:"bda-css-1",info:"",implemented:!0,hidden:!0,cat:"core"},"24 Hour Timestamps":{id:"bda-gs-6",info:"Replace 12hr timestamps with proper ones",implemented:!0,hidden:!1,cat:"core"},"Coloured Text":{id:"bda-gs-7",info:"Make text colour the same as role colour",implemented:!0,hidden:!1,cat:"core"},"BetterDiscord Blue":{id:"bda-gs-b",info:"Replace Discord blue with BD Blue",implemented:!0,hidden:!1,cat:"core"},"Developer Mode":{id:"bda-gs-8",info:"Developer Mode",implemented:!0,hidden:!1,cat:"core"},"Startup Error Modal":{id:"fork-ps-1",info:"Show a modal with plugin/theme errors on startup",implemented:!0,hidden:!1,cat:"fork"},"Show Toasts":{id:"fork-ps-2",info:"Shows a small notification for starting and stopping plugins & themes",implemented:!0,hidden:!1,cat:"fork"},"Scroll To Settings":{id:"fork-ps-3",info:"Auto-scrolls to plugin settins when opened (only if out of view)",implemented:!0,hidden:!1,cat:"fork"},"Emote Modifier Tooltip":{id:"fork-es-1",info:"Shows the emote modifier in the tooltip.",implemented:!0,hidden:!1,cat:"fork"},"Animate On Hover":{id:"fork-es-2",info:"Only animate the emote modifiers on hover",implemented:!0,hidden:!1,cat:"fork"},"Copy Selector":{id:"fork-dm-1",info:"Adds a \"Copy Selector\" option to context menus when developer mode is active",implemented:!0,hidden:!1,cat:"fork"},"Twitch Emotes":{id:"bda-es-7",info:"Show Twitch emotes",implemented:!0,hidden:!1,cat:"emote"},"FrankerFaceZ Emotes":{id:"bda-es-1",info:"Show FrankerFaceZ Emotes",implemented:!0,hidden:!1,cat:"emote"},"BetterTTV Emotes":{id:"bda-es-2",info:"Show BetterTTV Emotes",implemented:!0,hidden:!1,cat:"emote"},"Emote Menu":{id:"bda-es-0",info:"Show Twitch/Favourite emotes in emote menu",implemented:!0,hidden:!1,cat:"emote"},"Emoji Menu":{id:"bda-es-9",info:"Show Discord emoji menu",implemented:!0,hidden:!1,cat:"emote"},"Emote Autocomplete":{id:"bda-es-3",info:"Autocomplete emote commands",implemented:!1,hidden:!1,cat:"emote"},"Emote Auto Capitalization":{id:"bda-es-4",info:"Autocapitalize emote commands",implemented:!0,hidden:!1,cat:"emote"},"Show Names":{id:"bda-es-6",info:"Show emote names on hover",implemented:!0,hidden:!1,cat:"emote"},"Show emote modifiers":{id:"bda-es-8",info:"Enable emote mods (flip, spin, pulse, spin2, spin3, 1spin, 2spin, 3spin, tr, bl, br, shake, shake2, shake3, flap)",implemented:!0,hidden:!1,cat:"emote"}},defaultCookie={version:jsVersion,"bda-gs-0":!1,"bda-gs-1":!1,"bda-gs-2":!1,"bda-gs-3":!1,"bda-gs-4":!1,"bda-gs-5":!0,"bda-gs-6":!1,"bda-gs-7":!1,"bda-gs-8":!1,"bda-es-0":!0,"bda-es-1":!0,"bda-es-2":!0,"bda-es-3":!1,"bda-es-4":!1,"bda-es-5":!0,"bda-es-6":!0,"bda-es-7":!0,"bda-gs-b":!0,"bda-es-8":!0,"bda-jd":!0,"bda-dc-0":!1,"bda-css-0":!1,"bda-css-1":!1,"bda-es-9":!0,"fork-dm-1":!1,"fork-ps-1":!0,"fork-ps-2":!0,"fork-ps-3":!0,"fork-es-1":!0,"fork-es-2":!1},settingsCookie={},bdpluginErrors,bdthemeErrors,bdConfig=null;function Core(a){a?a.newLoader=!0:a={branch:"master",repo:"rauenzi",updater:{CDN:"cdn.rawgit.com"}},window.bdConfig=a}Core.prototype.init=function(){function a(){console.log(new Date().getTime()+" Defer"),0<document.querySelectorAll(".guilds .guild").length?(console.log(new Date().getTime()+" Defer Loaded"),s.injectExternals(),!bdpluginErrors&&(bdpluginErrors=[]),!bdthemeErrors&&(bdthemeErrors=[]),utils.log("Loading Plugins"),pluginModule=new PluginModule,pluginModule.loadPlugins(),utils.log("Loading Themes"),themeModule=new ThemeModule,themeModule.loadThemes(),utils.log("Updating Settings"),settingsPanel=new V2_SettingsPanel,settingsPanel.updateSettings(),utils.log("Initializing QuickEmoteMenu"),quickEmoteMenu.init(!1),window.addEventListener("beforeunload",function(){settingsCookie["bda-dc-0"]&&document.querySelector(".btn.btn-disconnect").click()}),publicServersModule.initialize(),emoteModule.autoCapitalize(),settingsCookie.version<jsVersion&&(settingsCookie.version=jsVersion,s.saveSettings()),utils.log("Removing Loading Icon"),$("head").append("<style>.CodeMirror{ min-width:100%; }</style>"),$("head").append("<style id=\"bdemotemenustyle\"></style>"),document.getElementsByClassName("bd-loaderv2")[0].remove(),settingsCookie["fork-ps-1"]&&(utils.log("Collecting Startup Errors"),s.showStartupErrors()),utils.log("Initializing Main Observer"),s.initObserver()):setTimeout(a,100)}var s=this,r="undefined"==typeof version?bdVersion:version;return r<supportedVersion?void this.alert("Not Supported","BetterDiscord v"+r+"(your version) is not supported by the latest js("+jsVersion+").<br><br> Please download the latest version from <a href='https://betterdiscord.net' target='_blank'>BetterDiscord.net</a>"):void(utils=new Utils,utils.getHash(),publicServersModule=new V2_PublicServers,emoteModule=new EmoteModule,quickEmoteMenu=new QuickEmoteMenu,voiceMode=new VoiceMode,dMode=new devMode,utils.log("Initializing EmoteModule"),emoteModule.init(),utils.log("Initializing Settings"),this.initSettings(),$(document).ready(function(){setTimeout(a,1e3)}))},Core.prototype.injectExternals=function(){},Core.prototype.initSettings=function(){if(void 0==$.cookie("better-discord"))settingsCookie=defaultCookie,this.saveSettings();else for(var a in this.loadSettings(),$("<style id=\"customcss\">").html(atob(window.bdStorage.get("bdcustomcss"))).appendTo(document.head),defaultCookie)void 0==settingsCookie[a]&&(settingsCookie[a]=defaultCookie[a],this.saveSettings())},Core.prototype.saveSettings=function(){$.cookie("better-discord",JSON.stringify(settingsCookie),{expires:365,path:"/"})},Core.prototype.loadSettings=function(){settingsCookie=JSON.parse($.cookie("better-discord"))},Core.prototype.initObserver=function(){let a=this;mainObserver=new MutationObserver(function(s){s.forEach(function(r){if("undefined"!=typeof pluginModule&&pluginModule.rawObserver(r),r.removedNodes.length&&r.removedNodes[0]instanceof Element){let o=r.removedNodes[0];(o.classList.contains("activityFeed-HeiGwL")||"friends"===o.id)&&pluginModule.channelSwitch()}if(r.addedNodes.length&&r.addedNodes[0]instanceof Element){let n=r.addedNodes[0];n.classList.contains("layer")&&(n.querySelector(".guild-settings-base-section")&&n.setAttribute("layer-id","server-settings"),n.getElementsByClassName("socialLinks-1oZoF3").length&&(n.setAttribute("layer-id","user-settings"),!n.querySelector("#bd-settings-sidebar")&&settingsPanel.renderSidebar())),n.classList.contains("popout")&&!n.classList.contains("popout-left")&&n.getElementsByClassName("emoji-picker").length&&quickEmoteMenu.obsCallback(n),(n.classList.contains("activityFeed-HeiGwL")||"friends"===n.id)&&pluginModule.channelSwitch(),(n.classList.contains("messages-wrapper")||n.querySelector(".messages-wrapper"))&&(a.inject24Hour(n),a.injectColoredText(n),pluginModule.channelSwitch()),n.classList.contains("message-group")&&!n.querySelector(".message-sending")&&(a.inject24Hour(n),a.injectColoredText(n),n.parentElement&&n.parentElement.children&&n==n.parentElement.children[n.parentElement.children.length-1]&&pluginModule.newMessage()),n.classList.contains("message")&&!n.classList.contains("message-sending")&&(a.injectColoredText(n.parentElement.parentElement),pluginModule.newMessage()),emoteModule.obsCallback(r)}})}),mainObserver.observe(document,{childList:!0,subtree:!0})},Core.prototype.inject24Hour=function(a){settingsCookie["bda-gs-6"]&&a.querySelectorAll(".timestamp").forEach(s=>{if(!s.getAttribute("data-24")){let r=s.innerText||s.textContent,n=/([^0-9]*)([0-9]?[0-9]:[0-9][0-9])([^0-9]*)/.exec(r);if(null!=n&&!(4>n.length)){let o=n[2].split(":"),l=parseInt(o[0]),d=o[1],u=n[3].toLowerCase();u.includes("am")&&12==l?l-=12:u.includes("pm")&&2>l&&(l+=12),l=("0"+l).slice(-2),s.innerText=n[1]+l+":"+d+n[3],s.setAttribute("data-24",n[2])}}})},Core.prototype.remove24Hour=function(a){a.querySelectorAll(".timestamp").forEach(s=>{if(s.getAttribute("data-24")){let r=s.getAttribute("data-24");s.removeAttribute("data-24");let n=s.innerText||s.textContent,o=/([^0-9]*)([0-9]?[0-9]:[0-9][0-9])([^0-9]*)/.exec(n);null==o||4>o.length||(s.innerText=o[1]+r+o[3])}})},Core.prototype.injectColoredText=function(a){settingsCookie["bda-gs-7"]&&a.querySelectorAll(".user-name").forEach(s=>{let r=s.style.color;"rgb(255, 255, 255)"===r||s.closest(".message-group").querySelectorAll(".markup").forEach(n=>{n.getAttribute("data-color")||(n.setAttribute("data-color",!0),n.style.setProperty("color",r))})})},Core.prototype.removeColoredText=function(a){a.querySelectorAll(".user-name").forEach(s=>{s.closest(".message-group").querySelectorAll(".markup").forEach(r=>{r.getAttribute("data-color")&&(r.removeAttribute("data-color"),r.style.setProperty("color",""))})})},Core.prototype.alert=function(a,s){let r=$(`<div class="bd-modal-wrapper theme-dark">
                    ...
                    <div class="bd-modal modal-2LIEKY">
                        <div class="bd-modal-inner inner-1_1f7b">
                ...
                </div>`);r.find(".footer button").on("click",()=>{r.addClass("closing"),setTimeout(()=>{r.remove()},300)}),r.find(".bd-backdrop").on("click",()=>{r.addClass("closing"),setTimeout(()=>{r.remove()},300)}),r.appendTo("#app-mount")},Core.prototype.showStartupErrors=function(){function a(n){let o=$(`<div class="errors">`);for(let l of n){let d=$(`<div class="error">
                            ...
                            </div>`);o.append(d),l.error&&d.find("a").on("click",u=>{u.preventDefault(),utils.err(`Error details for ${l.name?l.name:l.file}.`,l.error)})}return o}if(bdpluginErrors&&bdthemeErrors&&(bdpluginErrors.length||bdthemeErrors.length)){let s=$(`<div class="bd-modal-wrapper theme-dark">
                    <div class="bd-backdrop backdrop-2ohBEd"></div>
